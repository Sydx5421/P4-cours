...
<div class="card-body text-center">
    ...
    <h5>Commentaires signalés <?= $reportedCommentsNb;?></h5>
    <div>
    ...
    <h5>Nouveaux Commentaires <?= $newCommentsNb;?></h5>
    <div>
        <div class="media mb-4">  
            <form action="<?=$this->basePath?>dashboard" method="post">
                <table class="table">
                    ...
                    <tbody class="">
                        <?php if($newComments == null):?>
                        <tr class="d-flex">
                            <td class="col-12 text-center">
                                <h5 class="mt-0">Vous n'avez aucun nouveaux commentaires</h5>
                            </td>
                        </tr>
                        <?php endif ; ?>
